 ...
 */""")
	...
	def create(self,in_dir,out_dir):
		...
		xcconfig.write("OTHER_LDFLAGS[sdk=iphoneos4*]=$(inherited) -weak_framework iAd -weak_framework AssetsLibrary\n")
		xcconfig.write("OTHER_LDFLAGS[sdk=iphonesimulator4*]=$(inherited) -weak_framework iAd -weak_framework AssetsLibrary\n")
